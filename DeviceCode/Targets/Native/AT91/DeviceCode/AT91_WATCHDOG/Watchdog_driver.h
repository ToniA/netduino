...
struct AT91_WATCHDOG_Driver
{
    static HRESULT Watchdog_Enable();

    static void Watchdog_Disable();

    static void Watchdog_ResetCounter();

    static void Watchdog_ResetCpu();
};

extern AT91_WATCHDOG_Driver g_AT91_WATCHDOG_Driver;
