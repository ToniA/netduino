...
BOOL Watchdog_Driver::GetSetEnabled( BOOL fEnable, BOOL fSet )
{
    ...
    {
/*
        // Test code - light up the onboard led when turning the watchdog on
        CPU_GPIO_EnableOutputPin(AT91_GPIO_Driver::PB23, false);
        CPU_GPIO_SetPinState(AT91_GPIO_Driver::PB23, fEnable);
*/
...
UINT32 Watchdog_Driver::GetSetTimeout ( INT32 timeout_ms, BOOL fSet )
{
    ...
    // test code - reading the timeout causes a reset
    // ie. something like this on the managed side:
