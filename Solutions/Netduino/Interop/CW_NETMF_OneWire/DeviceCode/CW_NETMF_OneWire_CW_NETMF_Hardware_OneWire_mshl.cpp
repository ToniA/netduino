...
HRESULT Library_CW_NETMF_OneWire_CW_NETMF_Hardware_OneWire::ReadBit___BOOLEAN(CLR_RT_StackFrame& stack)
{
  TINYCLR_HEADER(); hr = S_OK;
  {
    CLR_RT_HeapBlock* pMngObj = Interop_Marshal_RetrieveManagedObject(stack);
    ...
    INT8 retVal = OneWire::ReadBit(pMngObj, hr);
    TINYCLR_CHECK_HRESULT(hr);
    SetResult_INT8(stack, retVal);
  }
  TINYCLR_NOCLEANUP();
...
HRESULT Library_CW_NETMF_OneWire_CW_NETMF_Hardware_OneWire::Write___VOID__BOOLEAN(CLR_RT_StackFrame& stack)
{
  TINYCLR_HEADER(); hr = S_OK;
  {
    CLR_RT_HeapBlock* pMngObj = Interop_Marshal_RetrieveManagedObject(stack);
    ...
    INT8 value;
    TINYCLR_CHECK_HRESULT(Interop_Marshal_INT8(stack, 1, value));
...
HRESULT Library_CW_NETMF_OneWire_CW_NETMF_Hardware_OneWire::Write___VOID__U1(CLR_RT_StackFrame& stack)
{
  TINYCLR_HEADER(); hr = S_OK;
  {
    CLR_RT_HeapBlock* pMngObj = Interop_Marshal_RetrieveManagedObject(stack);
...
HRESULT Library_CW_NETMF_OneWire_CW_NETMF_Hardware_OneWire::Search___I4__U1__SZARRAY_U1__I4__I4(CLR_RT_StackFrame& stack)
{
  TINYCLR_HEADER(); hr = S_OK;
  {
    CLR_RT_HeapBlock* pMngObj = Interop_Marshal_RetrieveManagedObject(stack);
    ...
    UINT8 command;
    TINYCLR_CHECK_HRESULT(Interop_Marshal_UINT8(stack, 1, command));

    CLR_RT_TypedArray_UINT8 buffer;
    TINYCLR_CHECK_HRESULT(Interop_Marshal_UINT8_ARRAY(stack, 2, buffer));

    INT32 deviation;
    TINYCLR_CHECK_HRESULT(Interop_Marshal_INT32(stack, 3, deviation));

    INT32 index;
    TINYCLR_CHECK_HRESULT(Interop_Marshal_INT32(stack, 4, index));
    ...
    INT32 retVal = OneWire::Search(pMngObj, command, buffer, deviation, index, hr);
    TINYCLR_CHECK_HRESULT(hr);
    SetResult_INT32(stack, retVal);
  }
  TINYCLR_NOCLEANUP();
