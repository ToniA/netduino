    ...
    namespace NETMF
    {
        namespace Hardware
        {
            struct OneWire
            {
                ...
                static UINT32& Get_pin( CLR_RT_HeapBlock* pMngObj )    { return Interop_Marshal_GetField_UINT32( pMngObj, Library_CW_NETMF_OneWire_CW_NETMF_Hardware_OneWire::FIELD__pin ); }
                ...
                static INT8 ReadBit( CLR_RT_HeapBlock* pMngObj, HRESULT &hr );
                ...
                static void WriteBit( CLR_RT_HeapBlock* pMngObj, INT8 param0, HRESULT &hr );
                static void WriteByte( CLR_RT_HeapBlock* pMngObj, UINT8 param0, HRESULT &hr );
                static INT32 Search( CLR_RT_HeapBlock* pMngObj, UINT8 param0, CLR_RT_TypedArray_UINT8 param1, INT32 param2, INT32 param3, HRESULT &hr );
